		    ...
		    switch($pp['extension'])
			{
				...
				case 'css':
					if ($is_processing)
					{
						...
						if (isset($_cms_person_photo_size_sx)) $file=str_replace('{@staff_photo_size_sx@}', $_cms_person_photo_size_sx, $file);
						if (isset($_cms_person_photo_size_sy)) $file=str_replace('{@staff_photo_size_sy@}', $_cms_person_photo_size_sy, $file);
						if (isset($_cms_person_photo_quality)) $file=str_replace('{@staff_photo_photo_quality@}', $_cms_person_photo_quality, $file);
